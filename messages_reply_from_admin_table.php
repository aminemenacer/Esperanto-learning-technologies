  ...
  <body style="overflow-x: hidden;">
    ...
    <div class="container">
		...
		<?php 
				...
				$reply_sender = $_SESSION['reply_sender']; 
				error_reporting(0); 
      ...
      <?php
         ...
         while($row = mysqli_fetch_array($result)){
             echo "<tr>";
              ...
              echo "<td>
                 <button style='background-color:#5AE339'  class='col_v'><a class='abtn' href=\"messages_view_reply_from_user.php?id=".$row['id']."\">View</a></button>";
