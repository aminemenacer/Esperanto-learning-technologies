...
$conn = mysqli_connect('localhost', 'amine', 'test1234', 'esperanto' );
		...
		$query = "SELECT * FROM content_update WHERE id = $id";
													...
													<div class="form-group row">                                                          
														...
														<div class="form-group row">
																	...
																	<div class="col-sm-8 col-md-8">
																		<p><?php echo $row['num_of_children']; ?></p>
																	</div>
															</div>
															<div class="form-group row">
																	<label for="name" class="col-sm-4 col-md-4 col-form-label"><b>Weekly attendance:</b></label> 
																	<div class="col-sm-8 col-md-8">
																		<p><?php echo $row['weekly_attendance']; ?></p>
																	</div>
															</div>                              
															<div class="form-group row">
																	<label for="email" class="col-sm-4 col-md-4 col-form-label"><b>Monthly attendance:</b></label> 
																	<div class="col-sm-8 col-md-8">
																			<p><?php echo $row['monthly_attendance']; ?></p>
																	</div>
															</div>
															<div class="form-group row">
																	<label for="email" class="col-sm-4 col-md-4 col-form-label"><b>Online attendance:</b></label> 
																	<div class="col-sm-8 col-md-8">
																			<p><?php echo $row['online_attendance']; ?></p>
																	</div>
															</div>
														<form action="content_update_view.php">
