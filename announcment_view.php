						...
						<div class="row">
							...
							<form method="post">
								<div class="form-group row">                                                          
									...
									<div class="form-group row">
												<label for="name" class="col-sm-4 col-md-4 col-form-label"><b>Announcment title:</b></label> 
												<div class="col-sm-8 col-md-8">
													<p><?php echo $row['news_title']; ?></p>
												</div>
										</div>
										<div class="form-group row">
												<label for="name" class="col-sm-4 col-md-4 col-form-label"><b>Announcment Description:</b></label> 
												<div class="col-sm-8 col-md-8">
									...
									<form action="announcment_view.php">
