...
<html lang="en">
  ...
  <body style="overflow-x: hidden;">
	...
	<div class="container" >
		...
		<p class="h1 text-center mt-2" style="padding: 10px">Profile page</p>
                    ...
                    <div class="col-sm-12">
																	...
																	<form method="post" action="profile.php">
																		...
																		<form action="profile.php">
																				<a href="users_profile_edit.php" class="btn btn-primary" role="button" aria-pressed="true">Edit profile</a>
																			</form>
