								...
								<div class="form-group row">                                                          
									...
									<div class="form-group row">
												...
												<div class="col-sm-8 col-md-8">
													<p><?php echo $row['rd_title']; ?></p>
												</div>
										</div>
										<div class="form-group row">
												<label for="name" class="col-sm-4 col-md-4 col-form-label"><b>Research & development Description:</b></label> 
												<div class="col-sm-8 col-md-8">
													<p style="white-space: pre-line;"><?php echo $row['rd_desc']; ?></p>
												</div>
										</div>                              
										
									<form action="r&d_view.php">
