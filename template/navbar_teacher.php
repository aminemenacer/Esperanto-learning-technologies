...
<html lang="en">
  ...
  <body>
      ...
      <a class="navbar-brand ml-2" href="index.php" style="color:white" ><b><h6>Esperanto (ELT)</h6></b></a>
      ...
      <div class="collapse navbar-collapse" text-right id="navbarText">
        <ul class="navbar-nav ml-5">
          <li class="nav-item active text-white">
           ...
           <li class="nav-item active text-white">
             <a class="nav-link text-white" href="user_logged_in.php">Account</a>
           </li>
           <li class="nav-item active text-white">
             <a class="nav-link text-white" href="contact.php">Contact</a>
           </li>
           <!--
           <li class="nav-item active text-white mr-3">
             <a class="nav-link text-white font-weight-bold" href="logout.php">Logout</a>
           </li>
           -->
											<form class="form-inline sm-form mr-2 ml-1">
										...
										<div class="dropdown show">
											...
											<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
													<a class="dropdown-item" href="user_logged_in.php">Profile</a>
