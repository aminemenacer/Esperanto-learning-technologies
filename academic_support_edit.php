...
if(isset($_GET['edit_id'])){
 ...
 $sql = "SELECT academic_title, academic_desc FROM academic_support WHERE id =" .$_GET['edit_id'];
...
if(isset($_POST['btn-update'])){
 ...
 $update = "UPDATE academic_support SET academic_title='$academic_title', academic_desc='$academic_desc' WHERE id=". $_GET['edit_id'];
                         ...
                         <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4 col-md-4">
                                 <input type="text" name="academic_title" aria-label="text" class="form-control" value="<?php echo $row['academic_title']; ?>"> 
                                </div>
                              </div>                              
                              <div class="form-group row">
                                <label for="email" class="col-sm-4 col-md-4 col-form-label"><b>Academic support description:</b></label> 
                                <div class="col-sm-8 col-md-8">
																																		<textarea name="academic_desc" rows="15" class="form-control"><?php echo $row['academic_desc']; ?></textarea>
                                </div>
                              </div>
																														                           
                              
                             <form action="academic_support_edit.php" method="GET">
